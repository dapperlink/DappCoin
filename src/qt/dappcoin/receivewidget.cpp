...
#include "qt/dappcoin/forms/ui_receivewidget.h"
...
#include "qt/dappcoin/addressholder.h"
...
ReceiveWidget::ReceiveWidget(DAPPGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive DAPP."));
