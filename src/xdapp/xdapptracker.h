...
#ifndef DAPP_XDAPPTRACKER_H
#define DAPP_XDAPPTRACKER_H
...
public:
    CxDAPPTracker(std::string strWalletFile);
    ~CxDAPPTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CxDAPPWallet* xDAPPWallet = NULL);
