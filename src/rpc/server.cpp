...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* DAPP features */
        {"dappcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"dappcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"dappcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"dappcoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"dappcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"dappcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"dappcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"dappcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"dappcoin", "startmasternode", &startmasternode, true, true, false},
        {"dappcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"dappcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"dappcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"dappcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"dappcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"dappcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"dappcoin", "preparebudget", &preparebudget, true, true, false},
        {"dappcoin", "submitbudget", &submitbudget, true, true, false},
        {"dappcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"dappcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"dappcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"dappcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"dappcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"dappcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"dappcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"dappcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"dappcoin", "mnsync", &mnsync, true, true, false},
        {"dappcoin", "spork", &spork, true, true, false},
        {"dappcoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getxdappseed", &getxdappseed, false, false, true},
        {"zerocoin", "setxdappseed", &setxdappseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdxdapp", &searchdxdapp, false, false, true},
        {"zerocoin", "dxdappstate", &dxdappstate, false, false, true},
...
{
    return "> dappcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:59187/\n";
}
