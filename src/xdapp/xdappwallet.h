// Copyright (c) 2017-2018 The DAPP developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef DAPP_XDAPPWALLET_H
#define DAPP_XDAPPWALLET_H
...
public:
    CxDAPPWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicXDAPP(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToXDAPP(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
