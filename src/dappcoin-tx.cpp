...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Dappcoin Core dappcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  dappcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dappcoin transaction") + "\n" +
                               "  dappcoin-tx [options] -create [commands]   " + _("Create hex-encoded dappcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded dappcoin transaction
