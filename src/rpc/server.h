...
extern UniValue DoXdappSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, std::vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setxdappseed(const UniValue& params, bool fHelp);
extern UniValue getxdappseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdxdapp(const UniValue& params, bool fHelp);
extern UniValue dxdappstate(const UniValue& params, bool fHelp);
