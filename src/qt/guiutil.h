...
/** Utility functions used by the DAPP Qt UI.
 */
namespace GUIUtil
{
...
// Render DAPP addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isXdapp = false);
...
// Parse "dappcoin:" URI into recipient object, return true on successful parsing
