...
#include "qt/dappcoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/dappcoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(DAPPGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to DAPPGUI::handleRestart()
