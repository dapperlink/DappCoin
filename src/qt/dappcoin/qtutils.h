...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, DAPPGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, DAPPGUI *gui, double posX = 3);
