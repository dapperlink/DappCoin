...
// Copyright (c) 2015-2018 The DAPP developers
...
/* Dappcoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "DAPP"
#define QAPP_ORG_DOMAIN "dapper.link"
#define QAPP_APP_NAME_DEFAULT "DAPP-Qt"
#define QAPP_APP_NAME_TESTNET "DAPP-Qt-testnet"
