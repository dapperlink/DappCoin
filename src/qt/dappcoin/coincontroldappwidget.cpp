...
#include "qt/dappcoin/coincontroldappwidget.h"
#include "qt/dappcoin/forms/ui_coincontroldappwidget.h"

CoinControlDappWidget::CoinControlDappWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlDappWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select DAPP Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("DAPP");
    ...
    ui->labelValueAfter->setText("0.00 DAPP");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 DAPP");
    ui->labelValueFee->setText("0.00 DAPP");
...
CoinControlDappWidget::~CoinControlDappWidget()
{
    delete ui;
}
