...
class RawTransactionsTest(DappcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid dappcoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid dappcoin address" in e.error['message'])
