                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strxDAPPPathCustom = GetArg("-xdappbackuppath", "");
    ...
    if(!strxDAPPPathCustom.empty()) {
        ui->wallet_customxdappbackuppath->setText(QString::fromStdString(strxDAPPPathCustom));
        ui->wallet_customxdappbackuppath_label->setVisible(true);
        ui->wallet_customxdappbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strxDAPPPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the DAPP RPC console.") + "<br>" +
