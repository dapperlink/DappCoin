 ...
 * DAPP system. There are three: the main network on which people trade goods
...
public:
    ...
    int DappcoinBadBlockTime() const { return nDappcoinBadBlockTime; }
    int DappcoinBadBlocknBits() const { return nDappcoinBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nDappcoinBadBlockTime;
    unsigned int nDappcoinBadBlocknBits;
