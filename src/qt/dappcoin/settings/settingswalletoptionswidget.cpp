...
#include "qt/dappcoin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/dappcoin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(DAPPGUI* _window, QWidget *parent) :
