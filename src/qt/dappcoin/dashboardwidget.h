...
#include "config/dappcoin-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalDapp = 0;
    qint64 totalXdapp = 0;
    QList<qreal> valuesDapp;
    QList<qreal> valuesxDapp;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(DAPPGUI* _window);
    ~DashboardWidget();
