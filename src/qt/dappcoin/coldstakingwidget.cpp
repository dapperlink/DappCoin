...
#include "qt/dappcoin/forms/ui_coldstakingwidget.h"
#include "qt/dappcoin/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/dappcoin/requestdialog.h"
#include "qt/dappcoin/tooltipmenu.h"
#include "qt/dappcoin/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(DAPPGUI* parent) :
    PWidget(parent),
    ui(new Ui::ColdStakingWidget)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your DAPPs, letting a hot node (24/7 online node)\nstake on your behalf, while you keep the keys securely offline."));
    ...
    ui->labelSubtitle2->setText(tr("Accept DAPP delegation / Delegate DAPP"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select DAPP outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 DAPP" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
